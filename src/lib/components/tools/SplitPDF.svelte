...
<div class="bg-white border border-slate-200 rounded-sm shadow-sm p-5 md:p-8">
    ...
    {#if file}
        <div class="mt-6 animate-in fade-in duration-300">
            <div
                class="flex items-center justify-between p-3 bg-slate-50 border border-slate-100 rounded-sm mb-6"
            >
                <div class="flex items-center gap-3 min-w-0">
                    <FileText size={18} class="text-slate-400 shrink-0" />
                    <div class="flex flex-col min-w-0">
                        <span class="text-[12px] font-bold text-black truncate"
                            >{file.name}</span
                        >
                        <div class="flex gap-2">
                            <span
                                class="text-[9px] font-mono text-slate-400 uppercase"
